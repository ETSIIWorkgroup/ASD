 ...
 class QPTimer
{
	private:
		...
		void ReadCycles (double *cycles);
		void PrintCycles (const char *pc, double *cycles);
		void PrintCyclesByIteration (const char *pc, double *cycles, double NumberOfIterations);
		void PrintTimeSeconds (const char *pc, double *cycles);
		void RestCycles (double *c_dif, double *c_final, double *c_init);
		void AddCycles (double *c_dif, double *c_final, double *c_init);
	public:
		...
		void PrintMinimumCyclesByIteration (const char* message, double NumberOfIterations);
};