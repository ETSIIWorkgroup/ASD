...
void 
	QPTimer::PrintMinimumCyclesByIteration(const char* message, double num)
{
	if(!DisableOutput)
...
void 
	QPTimer::PrintCyclesByIteration (const char *pc, double *cycles, double NumberOfIterations)
{
